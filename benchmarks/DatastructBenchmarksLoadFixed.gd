class_name DatastructBenchmarksLoadFixed
...
class DictionaryDynNamedLoadMember:
	extends IBenchmark
...
class DictionaryNamedLoadMember:
	extends IBenchmark
...
class DictionaryTypedNamedLoadMember:
	extends IBenchmark
...
class DictionaryDynNamedLoadIndexer:
	extends IBenchmark
...
class DictionaryNamedLoadIndexer:
	extends IBenchmark
...
class DictionaryTypedNamedLoadIndexer:
	extends IBenchmark
...
class DictionaryDynNamedLoadGet:
	extends IBenchmark
...
class DictionaryTypedNamedLoadGet:
	extends IBenchmark
...
class ObjectTypedNamedLoadMember:
	extends IBenchmark
...
class ObjectDynNamedLoadMember:
	extends IBenchmark
...
class ObjectTypedNamedLoadIndexer:
	extends IBenchmark
...
class ObjectDynNamedLoadIndexer:
	extends IBenchmark
